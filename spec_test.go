...
func TestPrev(t *testing.T) {
	runs := []struct {
		...
		{"Mon Jul 10 00:00 2012", "0 20-35/15 * * * *", "Tue Jul 9 23:35 2012"},
		{"Mon Jul 10 00:00 2012", "0 20-52/15 * * * *", "Tue Jul 9 23:50 2012"},
		{"Mon Jul 10 00:00 2012", "0 20-30/15 * * * *", "Tue Jul 9 23:20 2012"},
		{"Mon Jul 10 00:00 2012", "0 20-50/15 * * * *", "Tue Jul 9 23:50 2012"},
		...
		//
		{"Mon Jul 9 23:35:51 2012", "15/35 20-35/15 1/2 */2 * *", "Tue Jul 9 23:35:50 2012"},
		...
		{"Mon Jul 9 23:35 2012", "0 0 0 ? Apr,Aug,Oct Mon", "Sun Apr 30 00:00 2012"},
		{"Mon Jul 9 23:35 2012", "0 0 0 1/5 Oct Mon", "Mon Oct 31 00:00 2011"},
		//
		//// Wrap around years
		{"Mon Jul 9 23:35 2012", "0 0 0 * Feb Mon", "Mon Feb 27 00:00 2012"},
		{"Mon Jul 9 23:35 2012", "0 0 0 * Feb Mon/2", "Fri Feb 29 00:00 2012"},
		//
		//// Wrap around minute, hour, day, month, and year
		{"Mon Dec 31 23:59:45 2012", "0 * * * * *", "Mon Dec 31 23:59:00 2012"},
		{"Tue Jan 1 00:00:01 2013", "0 * * * * *", "Tue Jan 1 00:00:00 2013"},
		{"Tue Jan 1 00:00:11 2013", "0 * * * * *", "Tue Jan 1 00:00:00 2013"},

		//
		//// Leap year
		{"Mon Jul 9 23:35 2012", "0 0 0 29 Feb ?", "Wed Feb 29 00:00 2012"},
		//
		//// Daylight savings time 2am EST (-5) -> 3am EDT (-4)
		{"2012-03-11T00:00:00-0500", "TZ=America/New_York 0 30 2 11 Mar ?", "2011-03-11T02:30:00-0500"},
		//
		//// hourly job
		//{"2012-03-11T00:00:00-0500", "TZ=America/New_York 0 0 * * * ?", "2012-03-11T01:00:00-0500"},
		//{"2012-03-11T01:00:00-0500", "TZ=America/New_York 0 0 * * * ?", "2012-03-11T03:00:00-0400"},
	...
	quartzRuns := []struct {
		...
		//{"Mon Jul 9 23:35 2012", "0 0 0 * Feb Mon 2013", "Mon Feb 4 00:00 2013"},
		{"Mon Jul 9 23:35 2012", "0 0 0 * Feb Mon 2011", "Mon Feb 28 00:00 2011"},
		{"Mon Jul 9 23:35 2012", "0 0 0 * Feb Mon/2 2012/2", "Wed Feb 29 00:00 2012"},
		//
		//// No year provided
		//{"2012-11-04T00:00:00-0400", "TZ=America/New_York 0 0 * * * ?", "2012-11-04T01:00:00-0400"},
	}
